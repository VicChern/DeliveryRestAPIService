...
public class TenantTestIT extends AbstractTestNGSpringContextTests {
    ...
    @Test(groups = {"integration-tests"}, description = "Test Tenant_01. Should save tenant with valid fields for existing in db user.")
    ...
    //====================================================== guid ======================================================
    @Test(groups = {"integration-tests"}, description = "Test Tenant_02. Should throw ConstraintViolationException when saves tenant with null guid field for existing in db user",
    ...
    @Test(groups = {"integration-tests"}, description = "Test Tenant_03. Should throw DataIntegrityViolationException when saves tenant with not unique guid field for existing in db user",
    ...
    @Test(groups = {"integration-tests"}, description = "Test Tenant_04. Should throw ConstraintViolationException when saves tenant with null name field for existing in db user",
            expectedExceptions = ConstraintViolationException.class,
            expectedExceptionsMessageRegExp = "Validation failed .*")
    ...
    @Test(groups = {"integration-tests"}, description = "Test Tenant_05. Should throw ConstraintViolationException when saves tenant with empty name field for existing in db user",
            expectedExceptions = ConstraintViolationException.class,
            expectedExceptionsMessageRegExp = "Validation failed .*")
    ...
    @Test(groups = {"integration-tests"}, description = "Test Tenant_06. Should throw ConstraintViolationException when saves tenant (for existing in db user) with name field length more than " + MAX_LENGTH_256,
            expectedExceptions = ConstraintViolationException.class,
            expectedExceptionsMessageRegExp = "Validation failed .*")
